          ...
          <div className="grid grid-cols-3 gap-2">
            <label className="block space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  onSettings({ ...doc.settings, demand: Number(e.target.value) })
                }
              />
            </label>
            <label className="block space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  onSettings({ ...doc.settings, openingTime: Number(e.target.value) })
                }
              />
            </label>
            <label className="block space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  onSettings({ ...doc.settings, plannedBreaks: Number(e.target.value) })
                }
              />
            </label>
          </div>
